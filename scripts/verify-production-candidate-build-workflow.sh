...
require_literal 'azure_client_id="9f2c20b8-4d4b-4633-9659-2796a131fa8c"'
...
require_literal 'azure_principal_object_id="abc0d6b0-35ae-4d33-bcea-237fdca83a94"'
...
require_literal 'repository_exists="$(az acr repository list'
require_literal 'if [[ "${repository_exists}" == "0" ]]; then'
require_literal 'elif [[ "${repository_exists}" == "1" ]]; then'
require_literal 'ERROR: ACR repository inventory is invalid'
require_literal '--name workforceosprodacr'
...
require_literal '--registry workforceosprodacr'
...
require_literal 'image="workforceosprodacr.azurecr.io/apex-api@${digest}"'
...
assert_before 'az acr repository list' 'az acr repository show-tags'
