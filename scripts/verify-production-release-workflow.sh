...
require_literal 'production_control_storage_resource_id="/subscriptions/3171575e-f164-425c-9ee0-2fb10cf93884/resourceGroups/workforce-os-prod/providers/Microsoft.Storage/storageAccounts/workforceosprodctrl"'
require_literal '"${production_control_storage_container}" != "production-control"'
require_literal '"${production_control_storage_blob}" != "workforce-os/initial-production-bootstrap/state-v1.json"'
